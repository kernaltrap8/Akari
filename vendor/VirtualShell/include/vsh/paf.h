...
#define View_FindWidget paf_794CEACB
...
#define View_GetRCOSound paf_50CDB465
...
#define View_PlayRCOSound paf_B93AFE7E
//Example: PlayRCOSound( FindLoadedPlugin("system_plugin"), "snd_trophy", 1, 0)

extern "C" uint32_t paf_3A8454FC(int32_t* texptr, uint32_t plugin, const char* name); // return the texture address (atleast that's what i imagine what it does) by plugin name and texture name.
...
extern "C" wchar_t *paf_89B67B9C(uint32_t plugin, const char *text);  // gets localized string text from plugin resource (Different strings are returned depending on the system language) 	Example: (w)char (paf_F21655F3("system_plugin"), "msg_signed_out")
...
extern "C" void paf_0A1DC401(void*, int, void*);	  // _ZN3paf4View12SetInterfaceEiPv	paf::View::SetInterface(int, void *)
...
extern "C" void paf_022FDDB8(void*, float, float, float);	  // _ZN3paf6PhText7SetSizeEfff	paf::PhText::SetSize(float, float, float)
...
extern "C" void paf_7F0930C6(void* text, void* widget, void* appear); // _ZN3paf6PhTextC1EPNS_8PhWidgetEPNS_8PhAppearE	paf::PhText::PhText(paf::PhWidget *, paf::PhAppear *)
...
extern "C" void paf_D0197A7D(void* plane, void* widget, void* appear);	  // _ZN3paf7PhPlaneC1EPNS_8PhWidgetEPNS_8PhAppearE	paf::PhPlane::PhPlane(paf::PhWidget *, paf::PhAppear *)
// paf_CC58846C	  // _ZN3paf7PhPlaneC2EPNS_8PhWidgetEPNS_8PhAppearE	paf::PhPlane::PhPlane(paf::PhWidget *, paf::PhAppear *)
extern "C" void paf_0C16A258(void* plane);	  // _ZN3paf7PhPlaneD2Ev	paf::PhPlane::~PhPlane()
...
extern "C" void paf_165AD4A6(void*, int, float);	  // _ZN3paf7PhSText8SetStyleEif	paf::PhSText::SetStyle(int, float)
...
extern "C" void paf_190D4130(void* widget, void* child);	  // _ZN3paf8PhWidget11RegistChildEPS0_	paf::PhWidget::RegistChild(paf::PhWidget*)
extern "C" void paf_593FB1E5(void* widget, void const* child);	  // _ZN3paf8PhWidget11RemoveChildEPKS0_	paf::PhWidget::RemoveChild(paf::PhWidget const*)
...
extern "C" void paf_AFB4ECB9(void* widget, int layoutX, int layoutY, int layoutZ, vec4 pos);	  // _ZN3paf8PhWidget12SetLayoutPosEiii4vec4	paf::PhWidget::SetLayoutPos(int, int, int, vec4)
...
extern "C" void paf_6B2A00C5(void* widget, int layoutX, int layoutY, int layoutZ, vec4 size);	  // _ZN3paf8PhWidget13SetLayoutSizeEiii4vec4	paf::PhWidget::SetLayoutSize(int, int, int, vec4)
// paf_613A24BF	  // _ZN3paf8PhWidget13UpdateCamerasEv	paf::PhWidget::UpdateCameras(void)
extern "C" void paf_384F93FC(void* widget);	  // _ZN3paf8PhWidget13UpdatePrepareEv	paf::PhWidget::UpdatePrepare(void)
...
extern "C" void paf_F6E0A48F(void* widget, int r4, int r5, float f1);	  // _ZN3paf8PhWidget14SetLayoutStyleEiif	paf::PhWidget::SetLayoutStyle(int, int, float)
...
extern "C" void paf_67437488(void* widget, float* rotation, void* widgetTemplate, int r6);	  // _ZN3paf8PhWidget14SetRot_ontimerERK4vec4PS0_i	paf::PhWidget::SetRot_ontimer(vec4 const&, paf::PhWidget*, int)
...
extern "C" void paf_BF4B155C(void* widget);	  // _ZN3paf8PhWidget15UpdateLayoutPosEv	paf::PhWidget::UpdateLayoutPos(void)
...
extern "C" void paf_DF031EDD(void* widget);	  // _ZN3paf8PhWidget16UpdateLayoutSizeEv	paf::PhWidget::UpdateLayoutSize(void)
...
extern "C" void* paf_D557F850(void* widget, char const* child, int r5);	  // _ZN3paf8PhWidget9FindChildEPKci	paf::PhWidget::FindChild(char const*, int)
...
extern "C" void paf_738BAAC0(void* widget);	  // _ZN3paf8PhWidgetD2Ev	paf::PhWidget::~PhWidget()
...
extern "C" int paf_FE5A7950(void* handler, int cbId, void* phEvent);	  // _ZN3paf9PhHandler10DoCallBackEiPNS_7PhEventE	paf::PhHandler::DoCallBack(int, paf::PhEvent *)
extern "C" int paf_B60C4316(void* handler, void* phEvent);	  // _ZN3paf9PhHandler11HandlerProcEPNS_7PhEventE	paf::PhHandler::HandlerProc(paf::PhEvent *)
extern "C" int paf_2CBA5A33(void* handler, int cb);	  // _ZN3paf9PhHandler11KillTimerCBEi	paf::PhHandler::KillTimerCB(int)
extern "C" int paf_986427A7(void* handler, int cbId, void(*cb)(void* widget, void* phEvent, void*), void*);	  // _ZN3paf9PhHandler11SetCallBackEiPFvPNS_8PhWidgetEPNS_7PhEventEPvES5_	paf::PhHandler::SetCallBack(int, void (*)(paf::PhWidget *, paf::PhEvent *, void *), void *)
extern "C" int paf_818162F2(void* handler, void(*cb)(void* widget, void* phEvent, void*), void*);		  // _ZN3paf9PhHandler11SetDeleteCBEPFvPNS_8PhWidgetEPNS_7PhEventEPvES5_	paf::PhHandler::SetDeleteCB(void (*)(paf::PhWidget *, paf::PhEvent *, void *), void *)
extern "C" int paf_F7D65DC1(void* handler, void* phEvent);	  // _ZN3paf9PhHandler16HandleFocusEventEPNS_7PhEventE	paf::PhHandler::HandleFocusEvent(paf::PhEvent *)
extern "C" int paf_DBFE46EA(void* handler, void* phEvent);	  // _ZN3paf9PhHandler16HandlePointEventEPNS_7PhEventE	paf::PhHandler::HandlePointEvent(paf::PhEvent *)
extern "C" int paf_C051D361(void* handler, void* phEvent);	  // _ZN3paf9PhHandler16HandleStateEventEPNS_7PhEventE	paf::PhHandler::HandleStateEvent(paf::PhEvent *)
extern "C" int paf_C96D94F(void* handler, void* phEvent);	  // _ZN3paf9PhHandler17HandleSystemEventEPNS_7PhEventE	paf::PhHandler::HandleSystemEvent(paf::PhEvent *)
extern "C" int paf_CE14748C(void* handler, void* phEvent);	  // _ZN3paf9PhHandler18HandleCommandEventEPNS_7PhEventE	paf::PhHandler::HandleCommandEvent(paf::PhEvent *)
extern "C" int paf_A4D0FDCB(void* handler, void* phEvent);	  // _ZN3paf9PhHandler18HandleKeycodeEventEPNS_7PhEventE	paf::PhHandler::HandleKeycodeEvent(paf::PhEvent *)
extern "C" bool paf_4D0CAA13(void* handler, int cbId);	  // _ZN3paf9PhHandler9IsTimerCBEi	paf::PhHandler::IsTimerCB(int)
...
extern "C" float paf_20477524(void*);	  // _ZNK3paf6PhText13GetLineHeightEv	paf::PhText::GetLineHeight(void)const
...
extern "C" void paf_F5116A56(void*, int, float*);	  // _ZNK3paf7PhSText8GetStyleEiRf	paf::PhSText::GetStyle(int, float &)const
...
extern "C" void paf_A0FCDF5F(int* r3, int* r4);	  // pafGuGetCurrDisplayDeviceSurf
