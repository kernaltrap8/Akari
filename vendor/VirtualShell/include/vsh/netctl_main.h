...
extern "C" int32_t netctl_main_13CD17FB(void);  // sceNetCtlDelHandlerSysUtil finalize ?
...
extern "C" int32_t netctl_main_2DCA4721(uint32_t *);  // sceNetCtlGetStateSysUtil get..., arg1: int *   ret: a(0x00000003)
...
extern "C" int32_t netctl_main_3A5CB886(uint32_t *);  // sceNetCtlGetEtherInfoVsh
...
extern "C" int32_t netctl_main_9A528B81(int32_t size, const char *ip);  // sceNetCtlGetInfoVsh get ip addr of interface "eth0"
...
extern "C" int32_t netctl_main_EC73B49D(int32_t *arg1);  // sceNetCtlGetStateVsh get...
